...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (contaTransacaoSelect && isTransferenciaCheckboxContainer && isTransferenciaCheckbox && contaDestinoField) {
    ...
    if (backToTopButton && scrollContainer) {
        ...
        scrollContainer.addEventListener("scroll", () => {
            if (scrollContainer.scrollTop > 200) { // Aparece depois de rolar 200px
        ...
        // Executa a rolagem suave para o topo quando o botão é clicado
